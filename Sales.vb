...
Public Class Sales
    ...
    Private Sub Sales_Load(ByVal Sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Command.CommandText = "Retrieve_Sales"
    ...
    Private Sub Search_Button1_Click(sender As Object, e As EventArgs) Handles Search_Button1.Click
        ...
        Sales_Load(Me, New System.EventArgs)
    ...
    Private Sub Convert_CSV_Click(sender As Object, e As EventArgs) Handles Convert_CSV.Click
        ...
        Try
            ...
            ' handle Sation
            Dim Search_Station As String
            Search_Station = ComboBox_Station.SelectedItem
