...
Public Class Main
    ...
    Private Sub Convert_Click(sender As Object, e As EventArgs) Handles Convert.Click
        ...
        Dim FILE_NAME As String = Log_Dir & "\EODSales_" & File_Date & ".DAT"
        ...
        For Each File In Files
            ...
            If File.Attributes = FileAttributes.Archive Then
                ...
                Dim textReader As System.IO.StreamReader = My.Computer.FileSystem.OpenTextFileReader(File.FullName, System.Text.Encoding.Unicode)
                    ...
                    Try
                        ...
                        Select Case RecordType
                            ...
                            Case "502"
                                ...
                                Dim SqlQuery0 = "insert into sales_return (Report_Type,  Item_No, Transaction_id, Category_id, Extended_Sales_Price, Original_Amount, Extended_VAT, Mark_Down_Indicator, Sales_Mode, Product_EAN_Code, Product_ID, Product_Description, Quantity, Unit_Sales_Price, Unit_VAT, File_Name) Values ('" & Content & "')"
                                Command.CommandText = SqlQuery0
